...
% apilamiento. las variables de entrada del modelo son:  OP_Cromosomas
% (Soluciones a ordenar), OP_Matriz_objetivos (Funciones de ajuste) y
% OP_cant_objetivos (Cantidad de objetivos). Como variables de salida tiene
% dos soluciones sin transformar: OP_Cromosomas y OP_Matriz_objetivos.
% Además la variable OP_criterio_evaluacion (criterios de evaluación, donde
